...
@Controller
@RequestMapping("/kq/online")
public class KqOnlineController {
    ...
    public ModelAndView apply() {
        ...
        payStrategy.setStrategy(PaymentConstant.STRATEGY_ONLINE);
        payStrategy.setProvider(PaymentConstant.PROVIDER_KQ);
...
//				.post(entity, ResponseResult.class);
        ...
        return new ModelAndView("kq", "model", map.get("html"));
    }
