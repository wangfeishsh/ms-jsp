...
//        Map resultMap = ClientUtil.post("http://192.168.1.128:8081/pay-app/v1/p2p/fund/bid/apply", requireMap);
        Map resultMap = ClientUtil.post("http://localhost:8081/pay-app/v1/p2p/fund/bid/apply", requireMap);
