...
<%@page import="com.bao.util.Pkipair"%>
...
<%
	...
	String pageUrl = "http://180.166.49.242:8081/v1/online/callback/kq";
	//服务器接收支付结果的后台地址，该参数务必填写，不能为空。
	String bgUrl = "http://180.166.49.242:8081/v1/online/callback/kq";
	//网关版本，固定值：v2.0,该参数必填。
	String version = "v2.0";
	...
	String signType = "4";
	//支付人姓名,可以为空。
	String payerName = "鲍春雨";
	//支付人联系类型，1 代表电子邮件方式；2 代表手机联系方式。可以为空。
	String payerContactType = "2";
	//支付人联系方式，与payerContactType设置对应，payerContactType为1，则填写邮箱地址；payerContactType为2，则填写手机号码。可以为空。
	String payerContact = "";
	//商户订单号，以下采用时间来定义订单号，商户可以根据自己订单号的定义规则来定义该值，不能为空。
	String orderId = "0500042016092314512311234039";
	//订单金额，金额以“分”为单位，商户测试以1分测试即可，切勿以大金额测试。该参数必填。
	String orderAmount = "1";
	//订单提交时间，格式：yyyyMMddHHmmss，如：20071117020101，不能为空。
	String orderTime = "20160921102225";
	//商品名称，可以为空。
	String productName = "快钱即时充值";
	//商品数量，可以为空。
	String productNum = "1";
	//商品代码，可以为空。
	String productId = "1";
